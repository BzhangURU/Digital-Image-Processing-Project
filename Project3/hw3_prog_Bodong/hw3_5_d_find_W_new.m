...
%Io = ButterworthBandReject (I,Do,W,n);
    ...
    imwrite(original_frequency,'hw3_5_d_1original_frequency.png');
...
%     max(max(original_frequency(1:end*2/5,1:end*2/5)))
    ...
    imwrite(output_frequency,'hw3_5_d_2output_frequency.png');
...
imwrite(I,'hw3_5_d_3noisy1_image.png');
figure(4);imshow(Io_way2);title('output image');
imwrite(Io_way2,'hw3_5_d_4output_image.png');
