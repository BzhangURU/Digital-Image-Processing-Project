...
%Io = ButterworthBandReject (I,Do,W,n);
    ...
    imwrite(original_frequency,'hw3_5_b2_1freq_before_Butterworth.png');
    ...
    imwrite(output_frequency,'hw3_5_b2_2freq_after_Butterworth.png');
...
imwrite(I,'hw3_5_b2_3original_noisy_image.png');
figure(4);imshow(Io);title('output image');
imwrite(Io,'hw3_5_b2_4output_image_after_Butterworth.png');
%figure(3);imshow(Io);