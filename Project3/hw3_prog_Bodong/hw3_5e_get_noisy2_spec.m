...
%Io = ButterworthBandReject (I,Do,W,n);
    ...
    imwrite(original_frequency,'hw3_5_e1_freq_before_Butterworth.png');
    ...
    imwrite(output_frequency,'hw3_5_e2_freq_after_Butterworth.png');
...
imwrite(I,'hw3_5_e3_original_noisy_image.png');
figure(4);imshow(Io);title('output image');
imwrite(Io,'hw3_5_e4_output_image_after_Butterworth.png');