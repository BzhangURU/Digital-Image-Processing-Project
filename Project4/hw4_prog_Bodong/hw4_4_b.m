...
imwrite(fingerprint_gblur,'hw4_4_b_fingerprint_blur.png');
...
imwrite(Io_real,strcat('hw4_4_b_fingerprint_after_wiener_K',num2str(K),'.png'));
...
%display(strcat('a;sdfij',num2str(qq),'asdf'));
