...
imwrite(I/255,'hw2_6_a_1_original_image.png');
figure(2);imshow(g,[0,255]);title('original image add noise');
imwrite(g/255,'hw2_6_a_2_add_noise.png');
g=double(g);
g=g./255;
sigma=3;
Io = func_GaussianFilter_5_a(g, sigma);

figure(3);imshow(Io);title('after Gaussian filter');
imwrite(Io,'hw2_6_a_3_after_gaussian.png');
