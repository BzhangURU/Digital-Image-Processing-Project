...
Io_Bilateral=imread('hw2_5_c_lena_bilateral_sigmad3_sigmar10.png');
...
imwrite(Io_Bilateral_dif,'hw2_5_d_lena_dif_Bilateral.png');
...
figure(4);imshow(Io_Bilateral_dif_normalize);title('normalized difference between after Bilateral filter and original image');

imwrite(Io_Gaussian_dif_normalize,'hw2_5_d_lena_normalized_dif_Gaussian.png');
imwrite(Io_Bilateral_dif_normalize,'hw2_5_d_lena_normalized_dif_Bilateral.png');
